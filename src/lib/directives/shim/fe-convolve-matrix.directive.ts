...
export class SvgFeConvolveMatrixDirective {
  ...
  get bias(): number {
    return getAttr(this.elementRef, 'bias');
  }

  @Input('bias')
  set bias(value: number) {
    setAttr(this.elementRef, 'bias', value);
  }
  ...
  get divisor(): number {
    return getAttr(this.elementRef, 'divisor');
  }

  @Input('divisor')
  set divisor(value: number) {
    setAttr(this.elementRef, 'divisor', value);
  }
  ...
  get edgeMode(): string {
    return getAttr(this.elementRef, 'edgeMode');
  }

  @Input('edgeMode')
  set edgeMode(value: string) {
    setAttr(this.elementRef, 'edgeMode', value);
  }
  ...
  get kernelMatrix(): string {
    return getAttr(this.elementRef, 'kernelMatrix');
  }

  @Input('kernelMatrix')
  set kernelMatrix(value: string) {
    setAttr(this.elementRef, 'kernelMatrix', value);
  }


  get kernelUnitLength(): string {
    return getAttr(this.elementRef, 'kernelUnitLength');
  }

  @Input('kernelUnitLength')
  set kernelUnitLength(value: string) {
    setAttr(this.elementRef, 'kernelUnitLength', value);
  }
  ...
  get order(): string {
    return getAttr(this.elementRef, 'order');
  }

  @Input('order')
  set order(value: string) {
    setAttr(this.elementRef, 'order', value);
  }
  ...
  get preserveAlpha(): boolean {
    return getAttr(this.elementRef, 'preserveAlpha');
  }

  @Input('preserveAlpha')
  set preserveAlpha(value: boolean) {
    setAttr(this.elementRef, 'preserveAlpha', value);
  }


  get result(): string {
    return getAttr(this.elementRef, 'result');
  }

  @Input('result')
  set result(value: string) {
    setAttr(this.elementRef, 'result', value);
  }
  ...
  get targetX(): number {
    return getAttr(this.elementRef, 'targetX');
  }

  @Input('targetX')
  set targetX(value: number) {
    setAttr(this.elementRef, 'targetX', value);
  }


  get targetY(): number {
    return getAttr(this.elementRef, 'targetY');
  }

  @Input('targetY')
  set targetY(value: number) {
    setAttr(this.elementRef, 'targetY', value);
  }
