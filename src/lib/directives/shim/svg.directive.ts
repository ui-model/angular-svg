...
export class SvgSvgDirective {
  ...
  get contentScriptType(): string {
    return getAttr(this.elementRef, 'contentScriptType');
  }

  @Input('contentScriptType')
  set contentScriptType(value: string) {
    setAttr(this.elementRef, 'contentScriptType', value);
  }


  get contentStyleType(): string {
    return getAttr(this.elementRef, 'contentStyleType');
  }

  @Input('contentStyleType')
  set contentStyleType(value: string) {
    setAttr(this.elementRef, 'contentStyleType', value);
  }
