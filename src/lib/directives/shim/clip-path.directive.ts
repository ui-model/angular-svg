...
type ElementType = SVGClipPathElement;

@Directive({
  selector: 'clipPath',
})
export class SvgClipPathDirective {
  ...
  get clipPathUnits(): string {
    return getAttr(this.elementRef, 'clipPathUnits');
  }

  @Input('clipPathUnits')
  set clipPathUnits(value: string) {
    setAttr(this.elementRef, 'clipPathUnits', value);
  }
