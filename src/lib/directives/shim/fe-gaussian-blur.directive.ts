...
export class SvgFeGaussianBlurDirective {
  ...
  get stdDeviation(): string {
    return getAttr(this.elementRef, 'stdDeviation');
  }

  @Input('stdDeviation')
  set stdDeviation(value: string) {
    setAttr(this.elementRef, 'stdDeviation', value);
  }
