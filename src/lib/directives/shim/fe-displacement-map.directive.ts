...
export class SvgFeDisplacementMapDirective {
  ...
  get in2(): string {
    return getAttr(this.elementRef, 'in2');
  }

  @Input('in2')
  set in2(value: string) {
    setAttr(this.elementRef, 'in2', value);
  }
  ...
  get scale(): number {
    return getAttr(this.elementRef, 'scale');
  }

  @Input('scale')
  set scale(value: number) {
    setAttr(this.elementRef, 'scale', value);
  }
  ...
  get xChannelSelector(): string {
    return getAttr(this.elementRef, 'xChannelSelector');
  }

  @Input('xChannelSelector')
  set xChannelSelector(value: string) {
    setAttr(this.elementRef, 'xChannelSelector', value);
  }
  ...
  get yChannelSelector(): string {
    return getAttr(this.elementRef, 'yChannelSelector');
  }

  @Input('yChannelSelector')
  set yChannelSelector(value: string) {
    setAttr(this.elementRef, 'yChannelSelector', value);
  }
