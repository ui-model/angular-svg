...
type ElementType = SVGLinearGradientElement;

@Directive({
  selector: 'linearGradient',
})
export class SvgLinearGradientDirective {
  ...
  get x1(): string | number {
    return getAttr(this.elementRef, 'x1');
  }

  @Input('x1')
  set x1(value: string | number) {
    setAttr(this.elementRef, 'x1', value);
  }


  get x2(): string | number {
    return getAttr(this.elementRef, 'x2');
  }

  @Input('x2')
  set x2(value: string | number) {
    setAttr(this.elementRef, 'x2', value);
  }
  ...
  get y1(): string | number {
    return getAttr(this.elementRef, 'y1');
  }

  @Input('y1')
  set y1(value: string | number) {
    setAttr(this.elementRef, 'y1', value);
  }


  get y2(): string | number {
    return getAttr(this.elementRef, 'y2');
  }

  @Input('y2')
  set y2(value: string | number) {
    setAttr(this.elementRef, 'y2', value);
  }
