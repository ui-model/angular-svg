...
type ElementType = SVGRadialGradientElement;

@Directive({
  selector: 'radialGradient',
})
export class SvgRadialGradientDirective {
  ...
  get cx(): string | number {
    return getAttr(this.elementRef, 'cx');
  }

  @Input('cx')
  set cx(value: string | number) {
    setAttr(this.elementRef, 'cx', value);
  }


  get cy(): string | number {
    return getAttr(this.elementRef, 'cy');
  }

  @Input('cy')
  set cy(value: string | number) {
    setAttr(this.elementRef, 'cy', value);
  }
  ...
  get fx(): string | number {
    return getAttr(this.elementRef, 'fx');
  }

  @Input('fx')
  set fx(value: string | number) {
    setAttr(this.elementRef, 'fx', value);
  }


  get fy(): string | number {
    return getAttr(this.elementRef, 'fy');
  }

  @Input('fy')
  set fy(value: string | number) {
    setAttr(this.elementRef, 'fy', value);
  }
  ...
  get gradientTransform(): string {
    return getAttr(this.elementRef, 'gradientTransform');
  }

  @Input('gradientTransform')
  set gradientTransform(value: string) {
    setAttr(this.elementRef, 'gradientTransform', value);
  }


  get gradientUnits(): string {
    return getAttr(this.elementRef, 'gradientUnits');
  }

  @Input('gradientUnits')
  set gradientUnits(value: string) {
    setAttr(this.elementRef, 'gradientUnits', value);
  }
  ...
  get r(): string | number {
    return getAttr(this.elementRef, 'r');
  }

  @Input('r')
  set r(value: string | number) {
    setAttr(this.elementRef, 'r', value);
  }
  ...
  get spreadMethod(): string {
    return getAttr(this.elementRef, 'spreadMethod');
  }

  @Input('spreadMethod')
  set spreadMethod(value: string) {
    setAttr(this.elementRef, 'spreadMethod', value);
  }
