...
export class SvgAltGlyphDirective {
  ...
  get format(): string {
    return getAttr(this.elementRef, 'format');
  }

  @Input('format')
  set format(value: string) {
    setAttr(this.elementRef, 'format', value);
  }
  ...
  get glyphRef(): string {
    return getAttr(this.elementRef, 'glyphRef');
  }

  @Input('glyphRef')
  set glyphRef(value: string) {
    setAttr(this.elementRef, 'glyphRef', value);
  }
