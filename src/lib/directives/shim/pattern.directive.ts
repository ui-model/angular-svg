...
type ElementType = SVGPatternElement;
...
export class SvgPatternDirective {
  ...
  get patternTransform(): string {
    return getAttr(this.elementRef, 'patternTransform');
  }

  @Input('patternTransform')
  set patternTransform(value: string) {
    setAttr(this.elementRef, 'patternTransform', value);
  }


  get patternUnits(): string {
    return getAttr(this.elementRef, 'patternUnits');
  }

  @Input('patternUnits')
  set patternUnits(value: string) {
    setAttr(this.elementRef, 'patternUnits', value);
  }
