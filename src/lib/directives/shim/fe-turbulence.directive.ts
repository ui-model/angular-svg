...
@Directive({
  selector: 'feTurbulence',
})
export class SvgFeTurbulenceDirective {
  ...
  get baseFrequency(): string {
    return getAttr(this.elementRef, 'baseFrequency');
  }

  @Input('baseFrequency')
  set baseFrequency(value: string) {
    setAttr(this.elementRef, 'baseFrequency', value);
  }
  ...
  get numOctaves(): number {
    return getAttr(this.elementRef, 'numOctaves');
  }

  @Input('numOctaves')
  set numOctaves(value: number) {
    setAttr(this.elementRef, 'numOctaves', value);
  }
  ...
  get seed(): number {
    return getAttr(this.elementRef, 'seed');
  }

  @Input('seed')
  set seed(value: number) {
    setAttr(this.elementRef, 'seed', value);
  }
  ...
  get stitchTiles(): string {
    return getAttr(this.elementRef, 'stitchTiles');
  }

  @Input('stitchTiles')
  set stitchTiles(value: string) {
    setAttr(this.elementRef, 'stitchTiles', value);
  }
