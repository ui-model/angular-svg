...
export class SvgFeCompositeDirective {
  ...
  get k1(): number {
    return getAttr(this.elementRef, 'k1');
  }

  @Input('k1')
  set k1(value: number) {
    setAttr(this.elementRef, 'k1', value);
  }


  get k2(): number {
    return getAttr(this.elementRef, 'k2');
  }

  @Input('k2')
  set k2(value: number) {
    setAttr(this.elementRef, 'k2', value);
  }


  get k3(): number {
    return getAttr(this.elementRef, 'k3');
  }

  @Input('k3')
  set k3(value: number) {
    setAttr(this.elementRef, 'k3', value);
  }


  get k4(): number {
    return getAttr(this.elementRef, 'k4');
  }

  @Input('k4')
  set k4(value: number) {
    setAttr(this.elementRef, 'k4', value);
  }
  ...
  get operator(): string {
    return getAttr(this.elementRef, 'operator');
  }

  @Input('operator')
  set operator(value: string) {
    setAttr(this.elementRef, 'operator', value);
  }
