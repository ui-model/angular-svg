...
type ElementType = SVGFilterElement;

@Directive({
  selector: 'filter',
})
export class SvgFilterDirective {
  ...
  get filterRes(): string {
    return getAttr(this.elementRef, 'filterRes');
  }

  @Input('filterRes')
  set filterRes(value: string) {
    setAttr(this.elementRef, 'filterRes', value);
  }


  get filterUnits(): string {
    return getAttr(this.elementRef, 'filterUnits');
  }

  @Input('filterUnits')
  set filterUnits(value: string) {
    setAttr(this.elementRef, 'filterUnits', value);
  }
  ...
  get primitiveUnits(): string {
    return getAttr(this.elementRef, 'primitiveUnits');
  }

  @Input('primitiveUnits')
  set primitiveUnits(value: string) {
    setAttr(this.elementRef, 'primitiveUnits', value);
  }
