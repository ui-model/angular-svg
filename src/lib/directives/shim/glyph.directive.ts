...
export class SvgGlyphDirective {
  ...
  get glyphName(): string {
    return getAttr(this.elementRef, 'glyph-name');
  }

  @Input('glyph-name')
  set glyphName(value: string) {
    setAttr(this.elementRef, 'glyph-name', value);
  }
  ...
  get unicode(): string {
    return getAttr(this.elementRef, 'unicode');
  }

  @Input('unicode')
  set unicode(value: string) {
    setAttr(this.elementRef, 'unicode', value);
  }
