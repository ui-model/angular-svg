...
type ElementType = SVGTSpanElement;

@Directive({
  selector: 'tspan',
})
export class SvgTspanDirective {
  ...
  get dx(): string | number {
    return getAttr(this.elementRef, 'dx');
  }

  @Input('dx')
  set dx(value: string | number) {
    setAttr(this.elementRef, 'dx', value);
  }


  get dy(): string | number {
    return getAttr(this.elementRef, 'dy');
  }

  @Input('dy')
  set dy(value: string | number) {
    setAttr(this.elementRef, 'dy', value);
  }
  ...
  get lengthAdjust(): string {
    return getAttr(this.elementRef, 'lengthAdjust');
  }

  @Input('lengthAdjust')
  set lengthAdjust(value: string) {
    setAttr(this.elementRef, 'lengthAdjust', value);
  }
  ...
  get rotate(): string {
    return getAttr(this.elementRef, 'rotate');
  }

  @Input('rotate')
  set rotate(value: string) {
    setAttr(this.elementRef, 'rotate', value);
  }
  ...
  get textLength(): string | number {
    return getAttr(this.elementRef, 'textLength');
  }

  @Input('textLength')
  set textLength(value: string | number) {
    setAttr(this.elementRef, 'textLength', value);
  }
