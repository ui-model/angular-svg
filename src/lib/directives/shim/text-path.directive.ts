...
type ElementType = SVGTextPathElement;

@Directive({
  selector: 'textPath',
})
export class SvgTextPathDirective {
  ...
  get d(): string {
    return getAttr(this.elementRef, 'd');
  }

  @Input('d')
  set d(value: string) {
    setAttr(this.elementRef, 'd', value);
  }
  ...
  get method(): string {
    return getAttr(this.elementRef, 'method');
  }

  @Input('method')
  set method(value: string) {
    setAttr(this.elementRef, 'method', value);
  }
  ...
  get spacing(): string {
    return getAttr(this.elementRef, 'spacing');
  }

  @Input('spacing')
  set spacing(value: string) {
    setAttr(this.elementRef, 'spacing', value);
  }


  get startOffset(): string {
    return getAttr(this.elementRef, 'startOffset');
  }

  @Input('startOffset')
  set startOffset(value: string) {
    setAttr(this.elementRef, 'startOffset', value);
  }
