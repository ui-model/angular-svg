...
export class SvgAnimateMotionDirective {
  ...
  get keyPoints(): string {
    return getAttr(this.elementRef, 'keyPoints');
  }

  @Input('keyPoints')
  set keyPoints(value: string) {
    setAttr(this.elementRef, 'keyPoints', value);
  }
  ...
  get origin(): string {
    return getAttr(this.elementRef, 'origin');
  }

  @Input('origin')
  set origin(value: string) {
    setAttr(this.elementRef, 'origin', value);
  }


  get path(): string {
    return getAttr(this.elementRef, 'path');
  }

  @Input('path')
  set path(value: string) {
    setAttr(this.elementRef, 'path', value);
  }
