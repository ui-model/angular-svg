...
@Directive({
  selector: 'feSpecularLighting',
})
export class SvgFeSpecularLightingDirective {
  ...
  get specularConstant(): number {
    return getAttr(this.elementRef, 'specularConstant');
  }

  @Input('specularConstant')
  set specularConstant(value: number) {
    setAttr(this.elementRef, 'specularConstant', value);
  }
  ...
  get surfaceScale(): number {
    return getAttr(this.elementRef, 'surfaceScale');
  }

  @Input('surfaceScale')
  set surfaceScale(value: number) {
    setAttr(this.elementRef, 'surfaceScale', value);
  }
